...
class BienvenidaWidgetMobile extends StatefulWidget {
  final VoidCallback onEmpezar;
  const BienvenidaWidgetMobile({super.key, required this.onEmpezar});

  @override
  State<BienvenidaWidgetMobile> createState() => _BienvenidaWidgetMobileState();
}

class _BienvenidaWidgetMobileState extends State<BienvenidaWidgetMobile>
...
class BienvenidaWidgetMobileRenamed extends StatefulWidget {
  final VoidCallback onEmpezar;
  const BienvenidaWidgetMobileRenamed({super.key, required this.onEmpezar});

  @override
  State<BienvenidaWidgetMobileRenamed> createState() => _BienvenidaWidgetMobileRenamedState();
}

class _BienvenidaWidgetMobileRenamedState extends State<BienvenidaWidgetMobileRenamed>
    with TickerProviderStateMixin {
  bool _animando = false;
  final List<_Burbuja> _burbujas = [];
