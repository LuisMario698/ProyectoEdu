...
import 'package:proyectoeducativo/views/mobile/calendario_page.dart';
...
class CalendarioWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Este widget simplemente envuelve la página CalendarioPage para mantener
    // consistencia con la estructura de la aplicación
